        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center min-h-[80vh]">
          ...
          <div className="space-y-6 lg:space-y-8">
            ...
            <div className="relative">
              ...
              <div className="absolute bottom-0 left-[480px] bg-white/90 backdrop-blur-sm rounded-2xl p-3 lg:p-2 shadow-lg border border-lime-400 max-w-xs hidden lg:block">
